...
export const projects = [
  ...
  },
  {
    ...
    github: "",
    images: [
      "/projects/interpress/2-login.png",
      "/projects/interpress/1-splash.png",
      "/projects/interpress/3-liste-modu.png",
      "/projects/interpress/4-akis-modu.png",
    ],
    description: [
      "Media monitoring mobile app serving thousands of active users.",
      "Real-time tracking across TV, press, web, radio, and social media channels.",
      "List and feed modes with filtering, tagging, and reporting features.",
    ],
  },
  {
    title: "Adisyo Patron",
    github: "",
    images: [
      "/projects/adisyo-patron/1-login.png",
      "/projects/adisyo-patron/2-dashboard.png",
      "/projects/adisyo-patron/3-satis-dagilimi.png",
      "/projects/adisyo-patron/4-raporlar.png",
    ],
    description: [
      "Restaurant owner dashboard for multi-branch sales and performance tracking.",
      "Real-time metrics, payment analytics, and branch-based sales reports.",
      "Built with Flutter for restaurant chain management at scale.",
    ],
  },
  {
    title: "Dijital Basın",
    github: "",
    images: [
      "/projects/dijital-basin/1-ana-sayfa.png",
      "/projects/dijital-basin/2-dergi.png",
      "/projects/dijital-basin/3-gazete.png",
    ],
    description: [
      "Digital magazine and newspaper reading platform.",
      "Browse national and local publications with category filtering.",
      "In-app purchase and smooth reading experience on mobile.",
    ],
  },
  {
    title: "Bonservis",
    ...
    description: [
      "B2B mobile platform for wholesale food and beverage ordering.",
      "Product catalog, category navigation, cart, and enterprise workflows.",
      "Built with Flutter and Clean Architecture for long-term maintainability.",
    ],
  },
  {
    title: "Tap Grow",
    github: "",
    images: [
      "/projects/tapgrow/0-welcome.png",
      "/projects/tapgrow/1-onboarding.png",
      "/projects/tapgrow/2-dashboard.png",
      "/projects/tapgrow/3-ai-agents.png",
    ],
    description: [
      "AI-powered B2B mobile app with intelligent call agents for sales and support.",
      "Automates inbound & outbound calls, lead follow-ups, and customer workflows.",
      "Specialized AI agents for sales, appointments, support, and reminders.",
    ],
  },
];
